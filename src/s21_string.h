...
// Объявление своего значения NULL
#ifdef __cplusplus
#define S21_NULL 0  // NULL для C++
#else
#define S21_NULL ((void *)0)  // NULL для C
#endif

// Массивы ошибок для strerror для macos и linux
#ifdef __APPLE__
#define ERR_FIRST 0
#define ERR_LAST 106
...
#define S21_ERROR_MSG_LEN 100
#define S21_BUFFER_LEN 4096
// === Мемы ===
...
char *s21_strpbrk(const char *str1, const char *str2);  // стрпбрк
char *s21_strrchr(const char *str, int c);  // это вообще хз как читается
